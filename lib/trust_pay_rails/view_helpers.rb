module TrustPayRails
  module ViewHelpers
    ...
    def trust_pay_form(attributes={})
      form_tag TrustPayRails::Signature.bank_transfer_url do
    ...
    def trust_pay_card_form(attributes={})
      form_tag TrustPayRails::Signature.card_transfer_url do
        form_elements = trust_pay_form_elements(attributes)
    ...
    def trust_pay_form_elements(attributes={})
      form_elements = attributes.merge!(aid: TrustPayRails::Signature.aid).map do |name, value|
